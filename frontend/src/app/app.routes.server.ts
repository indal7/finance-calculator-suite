...
export const serverRoutes: ServerRoute[] = [
  ...
  { path: 'sip-calculator-1000-per-month', renderMode: RenderMode.Prerender },
  { path: 'sip-calculator-5000-per-month', renderMode: RenderMode.Prerender },
  { path: 'sip-calculator-1-crore', renderMode: RenderMode.Prerender },
  { path: 'sip-calculator-10-years', renderMode: RenderMode.Prerender },
